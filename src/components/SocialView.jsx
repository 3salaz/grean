          ...
          <div className="flex flex-col items-center justify-center w-full basis-1/2 gap-4">
            ...
            <div className="flex flex-col items-center justify-center gap-4 container">
              <div className="basis-1/2 h-full w-full flex items-center justify-center">
                <motion.button
                  className="bg-[#4081EC] rounded-full text-white w-[80%] px-2 py-2 flex flex-col items-center gap-4"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                >
                  <a
              ...
              <div className="basis-1/2 h-full w-full flex items-center justify-center">
                <motion.button
                  className="bg-[#EF0000] rounded-full text-white w-[80%] px-2 py-3 flex flex-col items-center gap-4"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                >
                  <a
