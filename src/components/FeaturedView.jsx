...
//     img: abruzzo,
//     imgSquare1: iphoneSize,
//     imgSquare2: iphoneSize,
//     imgSquare3: iphoneSize,
//     dietaryIcons: {
//       vegiterian: false,
//       special: false,
//       topRated: true,
...
//   {
//     name: "Bianca",
//     description: "Looking to cater you next event?",
//     img: iphoneSize,
//     imgSquare1: iphoneSize,
//     imgSquare2: iphoneSize,
//     imgSquare3: iphoneSize,
...
//     name: "Bolognese",
//     description:
//       "Top Sirloin Angus Beef, ground in a house, in a savory tomato sauce.",
//     img: iphoneSize,
//     imgSquare1: iphoneSize,
//     imgSquare2: iphoneSize,
//     imgSquare3: iphoneSize,
...
//     description:
//       "Fresh roasted eggpland with a combination of fresh herbs, garlic, and chili peppers in a light tomatoe sauce.",
//     img: iphoneSize,
//     imgSquare1: iphoneSize,
//     imgSquare2: iphoneSize,
//     imgSquare3: iphoneSize,
...
//     description:
//       "Freshly Roasted with beautiful herbs, in a mildly sweet and tangy tomatoe sauce.",
//     img: squash,
//     imgSquare1: iphoneSize,
//     imgSquare2: iphoneSize,
//     imgSquare3: iphoneSize,
...
//     name: "Mushroom",
//     description:
//       "Crimini and Portobello mushrooms with a garlic and fresh herbs in a rich red wine and tomato sauce.",
//     img: mushroom,
//     imgSquare1: iphoneSize,
//     imgSquare2: iphoneSize,
//     imgSquare3: iphoneSize,
...
// src/components/FeaturedView.jsx
// src/components/FeaturedView.jsx
      ...
      <section className="h-full flex flex-col justify-between relative">
        ...
        <div className="w-full h-[90%] flex flex-col justify-between items-center relative">
          <div className="w-full box-border flex flex-col items-center justify-center gap-6 relative">
            ...
            >
              {filteredMenuItems.map((item, index) => (
                <section
                  key={item.id}
                  className="flex-none items-center my-auto w-[95%] md:w-1/2 bg-mYellow  lg:w-1/5 snap-center hide-scroll box-border drop-shadow-lg px-2 gap-2"
                >
                  ...
                  <div className="p-3 text-left bg-white rounded-lg w-full h-full flex flex-col gap-1 justify-center">
                    <div className="text-xl line-clamp-1 font-bold text-mRed b">
                      {item.name}
                    </div>
                  ...
                  <div className="flex flex-wrap items-center justify-between w-full py-2">
                    <div className="basis-full rounded-sm">
                      {item ? (
                        // Check if any dietary icon is present
                        ...
                        item.dietaryIcons.includes("g'sFavorite") ? (
                          ...
                          <div className="h-10"></div> // Placeholder div to maintain space
                        )
                      ) : (
                        <div className="h-10"></div> // Placeholder div to maintain space
                      )}
          ...
          {/* <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="text-base bg-white rounded-full aspect-square w-6 flex items-center justify-center absolute bottom-24 right-8 drop-shadow-lg"
          >
